...
public class Matrix {
    ...
    public Matrix transpose() {
        ...
        int rowQuantity = getRowsQuantity();
        if (rowQuantity == columnsQuantity) {
            for (int i = 0; i < columnsQuantity; i++) {
                for (int j = i + 1; j < rowQuantity; j++) {
    ...
    public Matrix transposeSquareMatrix() {
