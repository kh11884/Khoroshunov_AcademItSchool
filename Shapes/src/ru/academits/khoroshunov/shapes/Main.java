...
public class Main {
    ...
    public static void main(String[] args) {
        Shapes[] shapes = {
                new Square(4),
                new Circle(2),
                new Triangle(1, 1, 3, 3, 1, 3),
                new Rectangle(4, 2),
                new Square(5),
                new Circle(3),
                new Triangle(2, 2, 4, 4, 2, 8),
                new Rectangle(1, 7),
                new Square(4.5),
                new Circle(2.5)
        };
        ...
        System.out.println("Shape with max area: " + shape1.getClass().getSimpleName() + ". Area - " + shape1.getArea());

        Shapes shape2 = getSecondAreaShape(shapes);
        System.out.println("Shape with max area: " + shape2.getClass().getSimpleName() + ". Area - " + shape2.getArea());
    }
}
